    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F5F1E8' }}>
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Main Headline */}
          <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ color: '#4A5D23', fontFamily: 'Georgia, Times New Roman, serif' }}>
            You Just Made the Right Decision.
          </h1>
          
          <p className="text-xl mb-12 max-w-2xl mx-auto" style={{ color: '#1A1A1A' }}>
