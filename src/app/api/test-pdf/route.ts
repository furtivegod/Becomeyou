...
export async function GET(request: NextRequest) {
  try {
    ...
    const samplePlanData = {
      ...
      overview:
        "This assessment revealed a pattern of using exhaustion and sleep as protective mechanisms against the demands of stepping into your vision of becoming a successful businessman, while simultaneously demonstrating that when you're engaged and winning, that exhaustion completely disappears.",
      assessment_overview:
        "You've been carrying a strategy that once gave you permission to rest, but now keeps you from building what you actually want. Today you've uncovered not just the exhaustion pattern, but why it exists—it protects you from having to give up the freedom to play games and football, and from facing the belief that you 'don't have talent.' The good news? You already have proof you can maintain high engagement and energy when something matters to you. That week of winning at games showed you exactly what your nervous system is capable of when it's genuinely activated.",
      development_profile:
        "Your nervous system shows remarkable resilience—you can regulate from stress in just a few minutes, which is a genuine strength most people don't have. But you've discovered something about yourself: when the path ahead requires you to become someone who gives up spontaneous freedom (playing football, gaming whenever you want), your body responds with deep exhaustion and you reach for sleep as an escape hatch. You said it yourself: 'I wanna be a success business man, but I don't have talent.' That sentence is doing a lot of work for you—it's giving you permission to stay exactly where you are. But here's what's also true: when you're winning at games, everything changes. Your mental state sharpens, your environment feels different, your exhaustion vanishes. You don't lack capacity. You lack a compelling enough reason to trade your current freedom for disciplined action.",
      bottom_line:
        "You have the foundation and potential for significant transformation—the key is working with your nervous system rather than against it.",
      sabotage_analysis: {
        protective_pattern:
          "Reaching for sleep and experiencing deep exhaustion when facing important tasks or decisions, speaking without deep thinking first. This pattern shows up most when you're confronting the gap between who you are and who you'd need to become to build the business success you want. When you notice it starting, you'll likely feel the weight of having to give up your spontaneous freedom first—that's your early warning signal. The faster you catch it, the faster you can choose differently.",
        what_its_protecting_from:
          "The fear of discovering you might actually lack the talent you need, the loss of freedom to play games and football whenever you want, the vulnerability of fully committing and potentially failing, and the identity shift required to become a disciplined businessman",
        how_it_serves_you:
          "Sleep and exhaustion give you a socially acceptable reason to avoid the hard work of business building without having to admit you're choosing comfort over growth. The 'I don't have talent' belief lets you off the hook from even trying fully. Your face turning red under pressure creates a visible reason to avoid high-stakes situations. Speaking without thinking keeps interactions surface-level so you don't have to be vulnerable or accountable.",
        go_to_patterns:
          "Three hours of sleep during the day, playing computer games for extended periods (at least a week-long stretches when winning), playing football, speaking reactively without processing thoughts first",
        success_proof:
          "That week when you were winning at computer games—you stayed completely engaged, alert, energized. No exhaustion. No need to escape. Your mental state, environment, and support system all aligned and you showed up fully. You already know what full engagement feels like.",
        anchor:
          "Singing songs—this is your unbreakable habit, the one you show up for even when everything else falls apart",
      },
      goals: {
        business_goal:
          "Become a successful businessman by leveraging your fast learning abilities and transferring your gaming 'winning state' to business actions",
        relationship_goal:
          "Build a support system for business growth while learning to navigate conflict directly rather than avoiding it",
        body_goal:
          "Use your body's early warning signals (face flushing, exhaustion) to interrupt escape patterns and redirect energy toward business learning",
      },
      future_vision:
        "A Tuesday where you wake up after singing, complete your business learning action, and feel the same 'winning' energy you get from games—but now it's directed toward building your business. You've reduced your escape sleep to 1.5 hours, you catch your exhaustion signals early, and you're accumulating proof that you're a fast learner who can succeed in business.",
      in_the_moment_reset:
      ...
      domain_breakdown: {
        mind: {
          ...
          key_strengths:
            "Quick stress regulation (few minutes recovery time), ability to maintain laser focus and mental sharpness when genuinely engaged (demonstrated during gaming wins), natural self-awareness about your patterns (you recognize the exhaustion and reactive speaking)",
          growth_opportunities:
            "Building the capacity to think before speaking, developing a compelling vision that rivals the immediate gratification of games, creating systems that protect your focus from impulse decisions, learning to recognize exhaustion as a choice rather than a condition",
        },
        body: {
          current_level: "Foundation",
          current_phase: "Friction",
          key_strengths:
            "Naturally quick nervous system regulation, visible stress signals (face redness) that give you early warning, ability to sustain energy during high engagement activities, consistent daily movement through singing",
          growth_opportunities:
            "Understanding why your body generates deep exhaustion as a protective response, building sustainable energy management that doesn't require 3 hours of daytime sleep, developing physical practices beyond singing that anchor you when stress hits, learning to use your visible stress response (face redness) as data rather than something to avoid",
        },
        spirit: {
          current_level: "Foundation",
          current_phase: "Friction",
          key_strengths:
            "Music as a spiritual practice and emotional outlet (singing songs daily), awareness of what freedom means to you (games, football), natural connection to joy and play, ability to experience flow states when winning",
          growth_opportunities:
            "Defining what success means beyond external validation, connecting to a purpose bigger than personal achievement, exploring what 'talent' actually means versus the story you're telling yourself, finding spiritual practices that ground you beyond entertainment and escape",
        },
        contribution: {
          current_level: "Foundation",
          current_phase: "Friction",
          key_strengths:
            "Clear vision of wanting to be a successful businessman, awareness that your current patterns aren't serving your goals, capacity for sustained engagement when motivated, willingness to examine your protective patterns honestly",
          growth_opportunities:
            "Translating business vision into concrete daily actions, building proof of competence that challenges the 'no talent' belief, creating structure that doesn't feel like prison, developing the discipline to delay gratification while maintaining joy",
        },
      },
      ...
      thirty_day_protocol: {
        ...
        thirty_day_approach:
          "Shift your identity narrative from 'I don't have talent' to 'I'm building evidence of my capability.' For 30 days, keep a visible tally of every small business action you complete—not outcomes, just actions. Every time you feel the exhaustion coming or reach for sleep during the day, look at your tally and ask: 'What's one more tally mark worth?' This directly challenges your core protective belief by creating undeniable proof that you can show up consistently, which is the real foundation of business success—not talent.",
        environmental_optimization:
          "Move your sleeping space away from your primary workspace, or if that's not possible, remove the option to lie down during the day by committing to taking your business work to a public space (coffee shop, library, co-working space) for at least 4 hours daily. Your environment is currently optimized for escape—optimize it for accountability instead. Also, set a visible timer for your gaming sessions and stop when it goes off, even if you're winning, to prove to yourself you can walk away from instant gratification.",
        progress_markers: [
      ...
      next_assessment: {
        six_month_followup:
          "6-Month Follow-Up Assessment recommended to track your decision-making confidence and behavioral changes",
        monthly_checkin:
          "Monthly Check-In Options to track: decision-making confidence, reduced overthinking patterns, increased action-taking, and overall behavioral optimization progress",
        focus_areas: [
        ...
        stay_connected:
          "How to Stay Connected: Join our newsletter for ongoing support, access our community forum for peer support, and schedule monthly check-ins to track your progress",
      },
    };
